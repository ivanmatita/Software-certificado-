...
import { CreditCard, Plus, ArrowRightLeft, TrendingUp, TrendingDown, DollarSign, Wallet, Calendar, Search, Filter, Edit2, X, User as UserIcon, AlertCircle, RefreshCw, Save, ArrowRight } from 'lucide-react';
            ...
            <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex items-center justify-between">
                        <div>
                            <p className="text-slate-500 text-xs uppercase font-bold">Saldo Total</p>
                    ...
                    <div className="bg-blue-600 p-6 rounded-xl text-white shadow-xl flex flex-col justify-center items-center gap-2 group cursor-pointer" onClick={() => alert("Redirecionando para Ordem de Transferência no RH...")}>
                        <ArrowRight size={32} className="group-hover:translate-x-2 transition-transform"/>
                        <p className="font-black uppercase text-xs tracking-widest">Transferir</p>
                    </div>
                </div>
        ...
        {showRegisterModal && (
            <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
                <div className="bg-white rounded-3xl w-full max-w-lg shadow-2xl overflow-hidden animate-in zoom-in-95">
                    ...
                    <div className="p-6 bg-slate-950 flex justify-end gap-3 border-t-4 border-slate-800">
